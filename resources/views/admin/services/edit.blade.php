                ...
                <form action="{{ route('admin.services.update', $service) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="duration_minutes" class="form-control" required min="15" value="{{ old('duration_minutes', $service->duration_minutes) }}">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label>Online Price (&#8377;)</label>
                            <input type="number" step="0.01" name="online_price" id="online_price" class="form-control" required min="0" value="{{ old('online_price', $service->online_price) }}">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label>Online Discount (&#8377;)</label>
                            <input type="number" step="0.01" name="online_discount" id="online_discount" class="form-control" min="0" value="{{ old('online_discount', $service->online_discount) }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <label>Offline Price (&#8377;)</label>
                            <input type="number" step="0.01" name="offline_price" id="offline_price" class="form-control" required min="0" value="{{ old('offline_price', $service->offline_price) }}">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label>Offline Discount (&#8377;)</label>
                            <input type="number" step="0.01" name="offline_discount" id="offline_discount" class="form-control" min="0" value="{{ old('offline_discount', $service->offline_discount) }}">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label>Rating (1-5)</label>
                            <input type="number" name="rating" class="form-control" min="1" max="5" value="{{ old('rating', $service->rating) }}">
                        </div>
                    </div>
