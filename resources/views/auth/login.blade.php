                    ...
                    <div class="col-12">
                        <div class="p-5">
                            <div class="text-center mb-5">
                                ...
                                <h3 class="fw-bold" style="font-family: 'Fraunces', serif;">Welcome Back</h3>
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="text-center">
                                    <p class="small text-muted mb-0">Don't have an account? <a href="{{ route('register') }}" class="text-success fw-bold text-decoration-none">Register Now</a></p>
                                </div>
                            </form>
                        </div>
                    </div>
